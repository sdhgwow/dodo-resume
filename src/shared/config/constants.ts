...
export const PERSONAL_INFO = {
    ...
    bio: 'Строю фронтенд с нуля до прода. Беру на себя ответственность за свои решения, довожу их до ума до того, как их увидит другой человек. По-настоящему владею своим кодом и по полочкам раскидываю, где и что лежит, чтобы разобраться мог любой',
